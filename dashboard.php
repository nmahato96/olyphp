...
$sql="SELECT * FROM product WHERE uid='".$_SESSION["id"]."' AND p_status='true'";
		...
		<section>
			...
			<div class="dashboard_container">
				...
				<div class="dashboard_second_menu">
					<div class="ad_status">
						<a href="dashboard.php" class="product_active">Active </a>|
						<a href="dashboard_inactive.php"> Inactive</a>
					</div>
							...
							<tbody>
								...
								while ($row=mysqli_fetch_assoc($result_pro)) {
									...
									<tr>
										...
										<td><span class="pro_id_del no_display"><?php echo $row["pid"];?></span><a onclick="deactivate_ad(this);" class="activate_ad"><i class="fas fa-arrow-down"></i> Deactivate Ad</a></td>
									</tr>
									<?php
								}
